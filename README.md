...
In this work, we performed a cross-dataset single-cell RNA-seq analysis of macrophages at **7 days post-injury (7 dpi)** across three independent spinal cord injury datasets to identify **four conserved macrophage populations (FSF1–FSF4)** that represent reproducible immune states after injury.
...
The goal of this project is to determine whether **macrophage subpopulations** observed after spinal cord injury are:
- dataset-specific artifacts  
or  
- **conserved biological immune states**

Using independent datasets and orthogonal validation (SingleR + DEG signatures), we defined four reproducible macrophage populations:

| FSF | Core biological identity |
|-----|-------------------------|
| **FSF1** | Inflammatory macrophages |
| **FSF2** | Inflammatory / interferon-associated |
| **FSF3** | Proliferative macrophages |
| **FSF4** | Lipid-handling / myelin-associated macrophages |
